...
import { editTransaction } from "@/app/transactions/create/_lib/action";
import {
  CurrencyDollarIcon,
  ListBulletIcon,
  CalendarDaysIcon,
...
import { fetchTransactionById } from "../_lib/data";
...
export default async function EditForm({ id }) {
  ...
  return (
    <form action={editTransaction.bind(null, transaction.id)}>
